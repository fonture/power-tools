...
export default class InputPanel extends Component {
    ...
    render() {
        ...
        for(let key in dataSet) {
            ...
            data.key = key
            if(isMonthlyFill && (type === 'regularAndSurplus' || type === 'protocolAndSurplus') && (current < 5 || current > 9) && (key == 'surplusPowerVolume' || key == 'surplusPowerPrice')) continue
            if(!isMonthlyFill && (type === 'regularAndSurplus' || type === 'protocolAndSurplus') && key === 'surplusPowerVolume') continue
            dataSets.push(data)
        }
        return (
